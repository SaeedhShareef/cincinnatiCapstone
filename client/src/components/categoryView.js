    ...
    render() {
        return (
            <div className="container">
                <center>
 <h1 className="underline shopHeader margin">Sights To See</h1>
 <img src={require('../assets/view.jpg')} alt="view" className="learnView margin"/>
<hr/>
...
<hr/>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/FYHIwThvqDs" title="sign" className="margin learnView" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
